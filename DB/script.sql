...
create table address(
	...
	user_id uuid,
	constraint "FK_3c2bc72f03fd5abbbc5ac169501" foreign key("user_id") references users("id")
);
...
create table "order"(
	...
	constraint "FK_3c2bc72f03fd5abbbc5ac169503" foreign key("user_id") references users("id")
);
...
(address, user_id)
VALUES('My New Address', (select id from users where name='Virat Kohli')),
('Who Cares', (select id from users where name='Sachin T')),
('Ha Ha Ha', (select id from users where name='MS Dhoni'));
...
VALUES(uuid_generate_v4(), 1, 330, (select id from users where name='Virat Kohli')),
(uuid_generate_v4(), 2, 40, (select id from users where name='Sachin T')),
(uuid_generate_v4(), 2, 240, (select id from users where name='Sachin T')),
(uuid_generate_v4(), 3, 220, (select id from users where name='MS Dhoni')),
(uuid_generate_v4(), 3, 310, (select id from users where name='MS Dhoni'));
...
create index user_phone_number on users("phone_number");
